...
sys.path.append('/home/heven/catkin_ws/src/heven_simul_2025/yolopv2_simul')
...
class LaneDetector():
    def __init__(self):
        ...
        # self.input_topic = "/usb_cam_yolo/image_raw/compressed"
        self.init_flag = 0
        self.count = 1
        ...
        for det in pred:
            if len(det):
                ...
                for *xyxy, conf, cls in det:
                    plot_one_box(xyxy, result_img, line_thickness=3)
                    ...
                    print(f"Confidence: {conf:.2f}, Class ID: {int(cls)}")
